...
from models.shap_explainer import plot_shap_bar_plotly
...
def generate_lime_content(lat, lon):
    lime_fig, prob_fig, _ = explain_with_lime(lat, lon)
    shap_fig = plot_shap_bar_plotly(lat, lon)
...
# CustomData from create_suitability_index_scattermap_figure is in plotting_functions.py
def generate_details_panel_content(point):
    ...
    return html.Div([
        ...
        create_distribution_figure(
            ...
            title='Correlation with <br>Existing Wind Farms',
